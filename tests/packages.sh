...
test "$("$circleback/bin/cb" --version)" = '0.3.1'
...
test "$("$claude_agent_acp/bin/claude-agent-acp" --version)" = '0.75.1'
test ! -e "$claude_agent_acp/bin/node"
test ! -e "$claude_agent_acp/bin/npm"
test ! -e "$claude_agent_acp/bin/npx"

test "$("$codex_acp/bin/codex-acp" --version)" = '@agentclientprotocol/codex-acp 1.11.0'
